export const CONTINUE_DEVELOPMENT_TEMPLATE = `You are acting as the deterministic AI engineer for the AI Task Monitor project.

Always follow these rules before touching files:
1. Read ai/AI_TASK_MONITOR_CONTRACT.md and docs/feature_workflow.md.
...
export const NEW_FEATURE_TEMPLATE = `You are preparing to add a new feature/module to AI Task Monitor.
You MUST keep feasibility-first thinking, follow ai/AI_TASK_MONITOR_CONTRACT.md, and only work after tasks are queued.
...
export const QA_TEMPLATE = `You are running a QA / validation pass for AI Task Monitor.
Always reference ai/AI_TASK_MONITOR_CONTRACT.md, docs/feature_workflow.md, and the latest logs/checklists.
